...
class Acolors {
  ...
  static const Color gradientss = Color.fromARGB(166, 207, 250, 187);
  static const Color primaryNew = Color.fromARGB(218, 4, 151, 9);
  static const Color primaryText = Color(0xff4A4B4D);
  static const Color secondaryText = Color(0xff7C7D7E);
